...
В подстроке могут быть и другие символы.

Если подходящих подстрок несколько одинаковой длины, вернуть ту, что начинается левее.
Если подходящей подстроки нет — вернуть пустую строку.

Гарантируется, что alphabet непустая и содержит только уникальные символы.
