...
lcSimilar:[{"n":33,"t":"Search in Rotated Sorted Array","h":"search-in-rotated-sorted-array"}],
repoSimilar:["bs2","bs3"]},
...
desc:`**LeetCode 347** — про **целые числа** в массиве nums (тип int), не про строки. Дан массив целых чисел nums и число k. Вернуть ==k наиболее часто встречающихся== элементов. Гарантируется, что ответ уникален. Ответ можно вернуть в любом порядке.
...
{id:"hpq2",t:"LC 692 · Top K Frequent Words",p:"Heap / PQ",d:"средне",
desc:`**Другая задача** (не LC 347): дан массив **строк** words и число k. Найти ==k самых частых слов==. При равной частоте — лексикографический порядок.
...
lcSimilar:[{"n":692,"t":"Top K Frequent Words","h":"top-k-frequent-words"}]},
...
lcSimilar:[{"n":1438,"t":"Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit","h":"longest-continuous-subarray-with-absolute-diff-less-than-or-equal-to-limit"}],
