...
desc:`Удалить из массива символов все вхождения смайликов :-) и :-(. После двоеточия, дефиса и первой скобки (')' или '(') нужно выкинуть и все подряд идущие такие же скобки того же типа (например ":-)))" целиком).
Что такое in-place
Работать нужно в том же массиве arr, без выделения второго массива под ответ.
Что вернуть
Метод возвращает целое число w — новую логическую длину массива (сколько символов осталось). Если w = 0, подходящих символов нет.
