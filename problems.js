const P = [
// ===== BACKTRACKING =====
{id:"1",t:"22. Generate Parentheses",p:"Backtracking",d:"средне",
...
{id:"2",t:"Декартово произведение",p:"Backtracking",d:"средне",
...
{id:"3",t:"Перебор IP-адресов",p:"Backtracking",d:"средне",
...
{id:"4",t:"Remove Invalid Parentheses",p:"Backtracking",d:"сложно",
...
{id:"5",t:"Letter Combinations of a Phone Number",p:"Backtracking",d:"средне",
...
// ===== BINARY SEARCH =====
{id:"6",t:"LC 33 — Search in Rotated Sorted Array",p:"Binary Search",d:"средне",
...
{id:"7",t:" LC 34 — Find First and Last Position of Element in Sorted Array",p:"Binary Search",d:"средне",
...
{id:"8",t:"LeetCode 704. Binary Search",p:"Binary Search",d:"легко",
...
// ===== TREES / DFS =====
{id:"9",t:"Validate BST",p:"Trees / DFS",d:"средне",
...
// ===== GEOMETRY HASH =====
{id:"10",t:"LeetCode 356: Line Reflection",p:"Geometry Hash",d:"средне",
...
{id:"11",t:"Строгая симметрия по оси Y",p:"Geometry Hash",d:"средне",
...
{id:"12",t:"LeetCode 356 — Line Reflection",p:"Geometry Hash",d:"средне",
...
// ===== GRAPH BFS =====
{id:"13",t:"Кратчайший путь в графе",p:"Graph BFS",d:"средне",
...
{id:"14",t:"Запутанный маршрут туриста",p:"Graph BFS",d:"средне",
desc:`Дан набор пар городов tickets, между которыми турист совершил ==прямые перелёты==. Информация о направлении перелётов утеряна — tickets[i] = [A, B] означает перелёт между A и B в ==любую сторону==. Также утерян ==порядок== перелётов.
...
Пример 1:
Ввод: tickets = [["Lima","Tokyo"]]
Вывод: ["Lima","Tokyo"]

Пример 2:
Ввод: tickets = [["Berlin","Rome"],["Berlin","Dubai"]]
Вывод: ["Dubai","Berlin","Rome"]

Пример 3:
Ввод: tickets = [["Berlin","Rome"],["Cairo","Rome"],["Berlin","Dubai"]]
Вывод: ["Dubai","Berlin","Rome","Cairo"]`,
hint:`Граф путей — ==простой путь (цепь)==: у двух концов степень 1, у остальных — 2. Берём любой лист, идём к единственному ещё непосещённому соседу, пока не исчерпаем n рёбер.`,
...
// ===== GRAPH TOPOSORT =====
{id:"15",t:"Циклические зависимости",p:"Graph Toposort",d:"средне",
...
{id:"16",t:"LC 207 — Course Schedule",p:"Graph Toposort",d:"средне",
...
{id:"17",t:" LC 802 — Find Eventual Safe States.",p:"Graph Toposort",d:"средне",
...
// ===== GREEDY =====
{id:"18",t:"LeetCode 122. Best Time to Buy and Sell Stock II",p:"Greedy",d:"легко",
...
{id:"19",t:"763 Partition Labels",p:"Greedy",d:"средне",
...
{id:"20",t:"Разбиение на 3 части",p:"Greedy",d:"легко",
...
{id:"21",t:"Подотрезок с минимумом X",p:"Greedy",d:"средне",
...
{id:"22",t:"LC 3105 Longest Strictly Increasing or Strictly Decreasing Subarray",p:"Greedy",d:"легко",
...
{id:"23",t:"Расстояние между X и Y",p:"Greedy",d:"средне",
...
{id:"24",t:"Половины с разницей ≤ k",p:"Greedy",d:"средне",
...
{id:"25",t:"Оптимизация маршрута",p:"Greedy",d:"средне",
...
{id:"26",t:"Maximize Distance to Closest Person",p:"Greedy",d:"средне",
...
// ===== HASHMAP =====
{id:"27",t:"LC 49. Group Anagrams",p:"HashMap",d:"средне",
...
{id:"28",t:"Слово-анаграмма",p:"HashMap",d:"легко",
...
{id:"29",t:"205 Isomorphic Strings",p:"HashMap",d:"средне",
...
{id:"30",t:"Удаление лишних дубликатов",p:"HashMap",d:"легко",
...
{id:"31",t:"Перестановка букв и палиндром",p:"HashMap",d:"средне",
...
{id:"32",t:"Маршрут туриста",p:"HashMap",d:"средне",
...
{id:"33",t:"Билеты по маршруту",p:"HashMap",d:"средне",
desc:`Задача: Восстановить цепочку маршрута по перепутанным билетам.
Входные данные:
...
Пример:
Ввод: tickets = [["London","Moscow"],["NY","London"],["Moscow","SPb"]], start = "NY"
Вывод: [["NY","London"],["London","Moscow"],["Moscow","SPb"]]`,
hint:`HashMap: город from → весь список-билет List<String> длины 2. Идём от start: добавляем билет, city = ticket.get(1).`,
code:`class Solution {
...
// ===== HEAP / PQ =====
{id:"34",t:"LeetCode 347 Top K Frequent Elements",p:"Heap / PQ",d:"средне",
...
{id:"35",t:"Top K Frequent Words",p:"Heap / PQ",d:"средне",
...
{id:"36",t:"LC 215 · Kth Largest Element in an Array",p:"Heap / PQ",d:"средне",
...
// ===== INTERVALS SWEEP =====
{id:"37",t:"Merge Intervals",p:"Intervals Sweep",d:"средне",
...
{id:"38",t:"Пересекающиеся отрезки",p:"Intervals Sweep",d:"средне",
...
{id:"39",t:"Car Pooling",p:"Intervals Sweep",d:"средне",
...
{id:"40",t:"LC253. Meeting Rooms II",p:"Intervals Sweep",d:"средне",
...
// ===== LINKED LIST =====
{id:"41",t:"LC 206 · Reverse Linked List",p:"Linked List",d:"легко",
desc:`Дан head ==односвязного списка==. ==Перевернуть (развернуть) список== и вернуть его новый head.
...
{id:"42",t:"Удалите N-й узел с конца",p:"Linked List",d:"средне",
...
// ===== MATH / SIMULATION =====
{id:"43",t:"Умножение длинного числа",p:"Math / Simulation",d:"средне",
...
{id:"44",t:"Сумма hex чисел",p:"Math / Simulation",d:"легко",
...
{id:"45",t:"Минимальное произведение",p:"Math / Simulation",d:"легко",
...
{id:"46",t:"Индекс Хирша",p:"Math / Simulation",d:"сложно",
...
// ===== PREFIX SUM =====
{id:"47",t:"LC 560 Subarray Sum Equals K",p:"Prefix Sum",d:"средне",
...
{id:"48",t:"Последовательность с суммой K",p:"Prefix Sum",d:"легко",
desc:`Дан неотсортированный массив nums целых чисел, необходимо определить, существует ли такая ==непрерывная последовательность, сумма элементов которой равна k (target)==.
...
{id:"49",t:"Последовательность с суммой K — диапазон индексов",p:"Prefix Sum",d:"средне",
...
{id:"50",t:"LC 523. Continuous Subarray Sum",p:"Prefix Sum",d:"средне",
...
{id:"51",t:"Пересечение множеств префиксов двух массивов",p:"Prefix Sum",d:"средне",
desc:`Даны два массива одинаковой длины N. Для каждого индекса i от 0 до N−1 нужно найти размер ==пересечения множеств== значений в префиксах A[0..i] и B[0..i] (каждый префикс рассматриваем как множество **уникальных** чисел, без кратности).

Пример:
Ввод: A = [1, 2, 3, 5, 4], B = [5, 3, 7, 4, 1]
Вывод: [0, 0, 1, 2, 4]

Пояснение:
- i = 0: в первом префиксе {1}, во втором {5} — пересечение пустое → 0
- i = 1: {1,2} и {5,3} — пусто → 0
- i = 2: {1,2,3} и {5,3,7} — общее только 3 → 1
- i = 3: {1,2,3,5} и {5,3,7,4} — общие 3 и 5 → 2
- i = 4: {1,2,3,4,5} и {1,3,4,5,7} — общие 1, 3, 4, 5 → 4

Связанные карточки: ps3, pse5 (перестановки 1..n — LC 2657), pse3 (без ограничения на перестановку, другая реализация).`,
hint:`Два HashSet текущих значений в префиксах. На шаге i сначала обновляем счётчик пересечения при добавлении A[i], затем при добавлении B[i] (проверять «уже есть в другом множестве» до вставки).`,
code:`import java.util.*;
...
repoSimilar:["174","102","100"]},

// ===== HASHMAP =====
{id:"52",t:"Пересечение двух массивов с учётом повторений",p:"HashMap",d:"легко",
...
// ===== PREFIX SUM EXT. =====
{id:"53",t:"LC 238 · Product of Array Except Self",p:"Prefix Sum Ext.",d:"легко",
...
{id:"54",t:" LC 724 — Find Pivot Index",p:"Prefix Sum Ext.",d:"средне",
...
// ===== SW + STRING =====
{id:"55",t:"Minimum Window Substring",p:"SW + String",d:"сложно",
...
repoSimilar:["57","62","63"]},

// ===== SLIDING WINDOW =====
{id:"56",t:"Longest Repeating Char Replacement",p:"Sliding Window",d:"средне",
...
// ===== SW + STRING =====
{id:"57",t:"Поиск анаграмм",p:"SW + String",d:"средне",
...
// ===== ONE PASS WITH STATE =====
{id:"58",t:"LC 674 Longest Continuous Increasing Subsequence",p:"One Pass with State",d:"легко",
...
// ===== SLIDING WINDOW =====
{id:"59",t:"Наглый подставной отчет",p:"Sliding Window",d:"средне",
...
// ===== ONE PASS WITH STATE =====
{id:"60",t:"LeetCode 1493 Longest Subarray of 1's After Deleting One Element.",p:"One Pass with State",d:"средне",
desc:`Дан массив из нулей и единиц. Нужно определить, какой максимальный по длине подинтервал
...
{id:"61",t:"Подставной отчет",p:"One Pass with State",d:"средне",
...
// ===== SW + STRING =====
{id:"62",t:"Подстроки с полным алфавитом",p:"SW + String",d:"средне",
desc:`Подсчитать ==количество подстрок==, содержащих ==все уникальные символы== s.

Пример:
Ввод: "abca"
Вывод: 3 (подстроки: "abca", "bca", "abc")`,
...
repoSimilar:["55","57","63"]},

{id:"63",t:"Поиск мутирующего вируса",p:"SW + String",d:"средне",
...
code:`public boolean containsMutation(String gene, String virus) {
...
repoSimilar:["55","57","62"]},

// ===== SLIDING WINDOW =====
{id:"64",t:"Инвестор в стране дураков",p:"Sliding Window",d:"средне",
...
// ===== STACK =====
{id:"65",t:"LC 20 · Valid Parentheses",p:"Stack",d:"легко",
...
{id:"66",t:"LeetCode 739 Daily Temperatures",p:"Stack",d:"средне",
...
{id:"67",t:"RPN-калькулятор",p:"Stack",d:"средне",
...
// ===== MATH / SIMULATION =====
{id:"68",t:"Простой калькулятор",p:"Math / Simulation",d:"средне",
...
{id:"69",t:"Базовый калькулятор ",p:"Math / Simulation",d:"средне",
desc:`Данна строка s, представляющая арифметическое выражение, состоящее из:
положительных целых чисел
операторов +, -, *, /
Выражение нужно вычислить с учётом стандартного приоритета операций:
* и / выполняются раньше, чем + и -.
Деление — целочисленное с округлением в сторону нуля.
Гарантируется отсутствие деления на ноль, все промежуточные значения помещаются в int.
...
Идём с шагом 2 (оператор → число)
При + или -: фиксируем предыдущее слагаемое в result и начинаем новое
При * или /: обновляем текущее слагаемое`,
ya:true},

// ===== STACK =====
{id:"70",t:"Разворот слов",p:"Stack",d:"легко",
...
// ===== TREES / DFS =====
{id:"71",t:"Number of Islands",p:"Trees / DFS",d:"средне",
...
{id:"72",t:"LC 101 Symmetric Tree",p:"Trees / DFS",d:"легко",
...
{id:"73",t:"LC 98 · Validate Binary Search Tree",p:"Trees / DFS",d:"легко",
...
{id:"74",t:"Поиск k-ого наименьшего",p:"Trees / DFS",d:"средне",
...
// ===== QUEUE / DESIGN =====
{id:"75",t:"146. LRU Cache",p:"Queue / Design",d:"средне",
...
// ===== TWO POINTERS =====
{id:"76",t:"Container With Most Water",p:"Two Pointers",d:"средне",
...
{id:"77",t:"LC 125. Valid Palindrome",p:"Two Pointers",d:"легко",
...
{id:"78",t:"LC 283. Move Zeroes",p:"Two Pointers",d:"легко",
...
{id:"79",t:"Сжатие пробелов",p:"Two Pointers",d:"легко",
...
{id:"80",t:"LC 392. Is Subsequence",p:"Two Pointers",d:"легко",
desc:`Даны две строки s и t. Необходимо определить, можно ли получить строку s, удаляя некоторые (возможно, ни одного) символы из строки t, не изменяя порядок оставшихся символов.
...
{id:"81",t:"LC 167. Two Sum II - Input Array Is Sorted",p:"Two Pointers",d:"легко",
...
{id:"82",t:"LC 350. Intersection of Two Arrays II",p:"Two Pointers",d:"легко",
...
{id:"83",t:"LC 228. Свертка в диапазоны (Summary Ranges)",p:"Two Pointers",d:"средне",
...
{id:"84",t:"Удаление смайликов",p:"Two Pointers",d:"легко",
...
{id:"85",t:"LC 443. String Compression",p:"Two Pointers",d:"средне",
...
{id:"86",t:"LC 680. Valid Palindrome II",p:"Two Pointers",d:"средне",
...
{id:"87",t:"LC 977. Squares of a Sorted Array",p:"Two Pointers",d:"легко",
...
// ===== STRINGS PREFIX =====
{id:"90",t:"LC 14 Longest Common Prefix",p:"Strings Prefix",d:"легко",
...
// ===== DEQUE =====
{id:"91",t:"LC 1438 Longest Continuous Subarray With Absolute Diff Less Than or Equal to Limit.",p:"Deque",d:"сложно",
...
{id:"93",t:"Разложение числа на минимальное количество квадратов",p:"Dynamic Programming",d:"средне",
desc:`Дано натуральное число ==N==. Нужно вернуть список из ==минимального количества элементов==, сумма квадратов которых равна N.
...
Ввод: N = 19
Вывод: [3, 3, 1]
Пояснение: 3^2 + 3^2 + 1^2 = 19, и это 3 элемента.
Вариант [4, 1, 1, 1] даёт 4 элемента, поэтому он не минимальный.

Пример 3:
Ввод: N = 7
Вывод: [2, 1, 1, 1]`,
hint:`Классический DP по сумме: dp[i] — минимальное число квадратов для i. Храним выбор chosen[i], чтобы восстановить список чисел, чьи квадраты использовались.`,
code:`class Solution {
...
{id:"94",t:"279. Perfect Squares",p:"Dynamic Programming",d:"средне",
desc:`Дано целое число ==n==. Нужно вернуть ==минимальное количество идеальных квадратов==, сумма которых равна n.
...
Ввод: n = 1
Вывод: 1`,
hint:`DP по сумме: dp[i] — минимальное число квадратов для суммы i. Перебираем все x, где x*x <= i, и пробуем взять квадрат x*x последним.`,
code:`class Solution {
...
lcSimilar:[{"n":279,"t":"Perfect Squares","h":"perfect-squares"}],
repoSimilar:["93"]},

// ===== STACK =====
{id:"95",t:"Скобочная грамматика",p:"Stack",d:"средне",
desc:`Дана строка s, представляющая выражение по скобочной грамматике:
...
{id:"96",t:"LC 341. Flatten Nested List Iterator",p:"Stack",d:"средне",
...
// ===== QUEUE / DESIGN =====
{id:"97",t:"FilteringIterator<T> — итератор по предикату",p:"Queue / Design",d:"средне",
...
hint:`Хранить lookahead: в advance() прокручивать внутренний итератор до следующего элемента, прошедшего предикат; вызывать advance() в конструкторе и после каждого next().`,
...
repoSimilar:["96","169","192"]},

{id:"98",t:"Поиск Person по имени (Optional)",p:"Queue / Design",d:"легко",
...
// ===== TWO POINTERS =====
{id:"99",t:"LC 1229. Meeting Scheduler",p:"Two Pointers",d:"средне",
...
// ===== PREFIX SUM EXT. =====
{id:"100",t:"Общий префикс без учёта кратности",p:"Prefix Sum Ext.",d:"средне",
...
{id:"101",t:"Общий префикс с учётом кратности",p:"Prefix Sum Ext.",d:"средне",
...
{id:"102",t:"Prefix Common Array",p:"Prefix Sum Ext.",d:"средне",
...
{id:"104",t:"Скалярное произведение векторов",p:"Two Pointers",d:"легко",
...
{id:"105",t:"Подсчёт пар индексов",p:"Two Pointers",d:"средне",
...
{id:"107",t:"К ближайших чисел",p:"Two Pointers",d:"средне",
...
{id:"108",t:"Минимальная разность",p:"Two Pointers",d:"легко",
...
// ===== HASHMAP =====
{id:"109",t:"Группировка чисел-анаграмм",p:"HashMap",d:"средне",
...
{id:"110",t:"Односторонняя разница",p:"HashMap",d:"легко",
...
// ===== TWO POINTERS =====
{id:"111",t:"Подсчёт пар с разницей >= К",p:"Two Pointers",d:"средне",
desc:`Дан массив целых чисел nums и целое число k. Необходимо найти количество пар элементов массива, разница которых больше или равна k.
...
{id:"112",t:"Рост акций компании",p:"Greedy with Min Tracker",d:"средне",
...
// ===== TWO POINTERS =====
{id:"113",t:"URL-ификация строки",p:"Two Pointers",d:"средне",
...
{id:"114",t:"LC 11. Container With Most Water",p:"Two Pointers",d:"средне",
...
// ===== TREES / DFS =====
{id:"115",t:"Поиск ближайшего значения в BST",p:"Trees / DFS",d:"средне",
...
{id:"116",t:"LC 938. Range Sum of BST",p:"Trees / DFS",d:"легко",
...
{id:"117",t:"LC 124. Binary Tree Maximum Path Sum",p:"Trees / DFS",d:"сложно",
...
// ===== TREES / BFS =====
{id:"118",t:"LC 103 · Binary Tree Zigzag Level Order Traversal",p:"Trees / BFS",d:"легко",
...
// ===== TREES / DFS =====
{id:"119",t:"LC 100 Same Tree",p:"Trees / DFS",d:"легко",
...
{id:"120",t:"LC 110 Balanced Binary Tree",p:"Trees / DFS",d:"легко",
...
{id:"121",t:"Path Sum II",p:"Trees / DFS",d:"средне",
...
{id:"122",t:"Lowest Common Ancestor III",p:"Trees / DFS",d:"средне",
...
{id:"123",t:"652 Find Duplicate Subtrees",p:"Trees / DFS",d:"средне",
...
- -200 ≤ Node.val ≤ 200`,
hint:`Для каждого поддерева задаём канонический id: ключ (val, id левого, id правого). Одинаковые поддеревья получают один id. HashMap считает, сколько раз встретился каждый id.`,
code:`class Solution {
...
{id:"124",t:"Поиск k-ого наибольшего в BST",p:"Trees / DFS",d:"средне",
...
{id:"125",t:"Проверка всех листьев",p:"Trees / DFS",d:"легко",
...
{id:"126",t:"Сумма от корня до листа",p:"Trees / DFS",d:"средне",
...
{id:"127",t:"Эквивалентные поддеревья по множеству букв",p:"Trees / DFS",d:"средне",
...
{id:"128",t:"Эквивалентные поддеревья максимального суммарного размера",p:"Trees / DFS",d:"сложно",
...
// ===== HASHMAP =====
{id:"129",t:"Count Pairs With Absolute Diff K",p:"HashMap",d:"легко",
...
{id:"130",t:"LC 350 Intersection of Two Arrays II",p:"HashMap",d:"легко",
...
{id:"131",t:"LC 387. Первый уникальный символ в строке",p:"HashMap",d:"легко",
...
{id:"132",t:"Group Anagrams для mixed-алфавита",p:"HashMap",d:"средне",
desc:`Дан массив строк. Нужно сгруппировать анаграммы, но строки могут содержать:
- русские буквы,
- английские буквы,
- спецсимволы.
...
Пример:
Ввод: ["кот!", "ток!", "abc#", "bca#", "aб"]
Вывод: [["кот!","ток!"], ["abc#","bca#"], ["aб"]]`,
hint:`Для универсального алфавита не использовать массив фиксированного размера. Строим ключ через частоты символов (Map), затем группируем по этому ключу.`,
code:`class Solution {
...
{id:"133",t:"Первый уникальный символ в строке",p:"HashMap",d:"легко",
desc:`Дана строка. Нужно вернуть ==первый символ== строки, который встречается в ней ровно один раз.
...
Пример 2:
Ввод: "aabbcc"
Вывод: '�' (уникального символа нет)`,
hint:`Сначала посчитай частоты всех символов, затем вторым проходом найди первый символ с частотой 1.`,
code:`class Solution {
...
{id:"134",t:"Группировка чисел по перестановке цифр (нули незначимы)",p:"HashMap",d:"средне",
desc:`Дан массив неотрицательных целых чисел. Нужно сгруппировать числа, которые можно получить друг из друга перестановкой цифр.
Важно:
...
Пример:
Ввод: [1230, 99, 23001, 123, 111, 300021, 101010, 90000009, 9]
Вывод: [[99, 90000009], [111, 101010], [1230, 23001, 123, 300021], [9]]

Ввод: [11, 22]
Вывод: [[11], [22]]`,
hint:`Строим канонический ключ по частотам цифр 1..9 (цифру 0 игнорируем). Числа с одинаковым ключом попадают в одну группу.`,
code:`class Solution {
...
// ===== SLIDING WINDOW =====
{id:"135",t:"Minimum Size Subarray Sum",p:"Sliding Window",d:"средне",
...
// ===== DEQUE =====
{id:"136",t:"Sliding Window Maximum",p:"Deque",d:"сложно",
...
// ===== TWO POINTERS =====
{id:"137",t:"LeetCode 161: One Edit Distance",p:"Two Pointers",d:"средне",
desc:`Проверить, находятся ли две строки на расстоянии ==ровно одной правки (одного изменения)== (вставка, удаление или замена одного символа).
...
// ===== HASHMAP =====
{id:"138",t:"Longest Palindrome Two Letter Words",p:"HashMap",d:"средне",
...
// ===== TWO POINTERS =====
{id:"139",t:"LC 243 · Shortest Word Distance",p:"Two Pointers",d:"легко",
...
{id:"140",t:"LC 821 Shortest Distance to a Character",p:"Two Pointers",d:"легко",
...
{id:"142",t:"LeetCode 42 Trapping Rain Water",p:"Two Pointers",d:"сложно",
desc:`Дан массив высот столбиков. Посчитать ==сколько воды задерживается== после дождя. Вода может стоять только в ямках между более высокими стенками.
...
// ===== DYNAMIC PROGRAMMING =====
{id:"143",t:"Longest Mountain in Array",p:"Dynamic Programming",d:"средне",
...
// ===== TWO POINTERS =====
{id:"144",t:"LC 125 Valid Palindrome",p:"Two Pointers",d:"легко",
...
{id:"145",t:"LC 167 · Two Sum II - Input Array Is Sorted",p:"Two Pointers",d:"легко",
...
{id:"146",t:"LC 344 Reverse String",p:"Two Pointers",d:"легко",
...
{id:"147",t:"LeetCode 26. Remove Duplicates from Sorted Array",p:"Two Pointers",d:"легко",
...
{id:"148",t:"LC 27 Remove Element",p:"Two Pointers",d:"легко",
...
{id:"149",t:"LC 283 · Move Zeroes",p:"Two Pointers",d:"легко",
...
code2:`public void moveZeroes(int[] nums) {
    int slow = 0;
    for (int fast = 0; fast < nums.length; fast++) {
        if (nums[fast] != 0) {
            int temp = nums[slow];
...
{id:"150",t:"LC 392 · Is Subsequence",p:"Two Pointers",d:"легко",
...
{id:"151",t:"LC 680 · Valid Palindrome II",p:"Two Pointers",d:"легко",
...
{id:"152",t:"Container With Most Water",p:"Two Pointers",d:"средне",
...
{id:"153",t:"3Sum",p:"Two Pointers",d:"средне",
...
{id:"154",t:"LeetCode 16. 3Sum Closest",p:"Two Pointers",d:"средне",
...
{id:"155",t:"4Sum",p:"Two Pointers",d:"средне",
...
{id:"156",t:"Sort Colors",p:"Two Pointers",d:"средне",
...
{id:"157",t:"LeetCode 142. Linked List Cycle II",p:"Two Pointers",d:"средне",
...
{id:"158",t:"Find the Duplicate Number",p:"Two Pointers",d:"средне",
...
{id:"161",t:"Boats to Save People",p:"Two Pointers",d:"средне",
...
{id:"162",t:"Interval List Intersections",p:"Two Pointers",d:"средне",
...
{id:"163",t:"Max Consecutive Ones III",p:"Two Pointers",d:"средне",
...
{id:"164",t:"LC 1768 · Merge Strings Alternately",p:"Two Pointers",d:"легко",
...
{id:"165",t:"Односторонняя разница",p:"Two Pointers",d:"легко",
desc:`Даны два массива nums1 и nums2, отсортированные по не убыванию.
...
{id:"166",t:"К ближайших чисел (якорь idx)",p:"Two Pointers",d:"легко",
...
{id:"167",t:"LC 234. Палиндром в связном списке",p:"Two Pointers",d:"легко",
...
repoSimilar:["157","77","86"]},

{id:"168",t:"LC 557. Reverse Words in a String III",p:"Two Pointers",d:"легко",
...
{id:"169",t:"LC 281. Zigzag Iterator",p:"Two Pointers",d:"средне",
...
// ===== INTERVALS SWEEP =====
{id:"170",t:"LC 163 · Missing Ranges",p:"Intervals Sweep",d:"легко",
...
{id:"171",t:"LC 228 · Summary Ranges",p:"Intervals Sweep",d:"легко",
...
{id:"172",t:"Interval List Intersections",p:"Intervals Sweep",d:"средне",
...
{id:"173",t:"986. Interval List Intersections",p:"Intervals Sweep",d:"средне",
...
// ===== PREFIX SUM =====
{id:"174",t:"Prefix Common Array",p:"Prefix Sum",d:"средне",
...
// ===== ONE PASS WITH STATE =====
{id:"175",t:"LC 674 · Longest Continuous Increasing Subsequence",p:"One Pass with State",d:"легко",
...
// ===== SLIDING WINDOW =====
{id:"176",t:"LC 643 · Maximum Average Subarray I ",p:"Sliding Window",d:"легко",
...
{id:"177",t:"Subarrays of Size K and Average > Threshold",p:"Sliding Window",d:"средне",
...
{id:"178",t:"Longest Substring Without Repeating Characters",p:"Sliding Window",d:"средне",
...
{id:"179",t:"Подстроки без повторов — число пар (i, j)",p:"Sliding Window",d:"средне",
...
code:`public long countSubstrings(String s) {
...
{id:"180",t:"LC 340 · Longest Substring with At Most K Distinct Characters",p:"Sliding Window",d:"средне",
desc:`Дана строка ==s== и целое число ==k==. Нужно найти длину ==самой длинной подстроки==, которая содержит не более k различных символов.

Пример 1:
Ввод: s = "eceba", k = 2
Вывод: 3
Пояснение: "ece" содержит только 2 различных символа ('e' и 'c').

Пример 2:
Ввод: s = "aa", k = 1
Вывод: 2
Пояснение: вся строка "aa" подходит.

Пример 3:
Ввод: s = "abcabcbb", k = 2
Вывод: 4
Пояснение: подходит, например, "bcbb" (2 различных символа: 'b' и 'c').

Ограничения:
- 1 <= s.length <= 5 * 10^4
- 0 <= k <= 50
- s состоит из английских букв, цифр, пробелов и знаков препинания`,
hint:`Скользящее окно + частоты символов в HashMap. Расширяем окно вправо, а если уникальных символов стало больше k — сжимаем слева, пока снова не станет <= k.`,
code:`class Solution {
...
// ===== MATH / SIMULATION =====
{id:"181",t:"Умножение строк",p:"Math / Simulation",d:"средне",
...
{id:"182",t:"LC 415. Сложение строк",p:"Math / Simulation",d:"легко",
...
// ===== QUEUE / DESIGN =====
{id:"185",t:"UserStatistics: окно k мс и ≥ limit запросов",p:"Queue / Design",d:"средне",
...
code:`public String rle(String s) {
    if (s == null || s.isEmpty()) {
...
// ===== SLIDING WINDOW =====
{id:"188",t:"Поиск подстроки с точностью до перестановки",p:"Sliding Window",d:"средне",
...
{id:"189",t:"Кратчайшая подстрока, покрывающая алфавит",p:"Sliding Window",d:"средне",
...
// ===== TWO POINTERS =====
{id:"190",t:"Ближайший митинг",p:"Two Pointers",d:"средне",
...
{id:"191",t:"Минимальная абсолютная разность между двумя массивами",p:"Two Pointers",d:"средне",
desc:`Даны два НЕ ОТСОРТИРОВАННЫХ массива ==a== и ==b==. Нужно найти минимальное значение ==abs(a[i] - b[j])== по всем парам индексов i, j.

Пример 1:
Ввод: a = [7, 1, 3], b = [10, 5, 2]
Вывод: 1
Пояснение: минимальная разность достигается, например, на паре (3, 2): |3-2| = 1.

Пример 2:
Ввод: a = [1, 2, 3], b = [7, 8, 9]
Вывод: 4`,
hint:`Отсортируй оба массива и иди двумя указателями. На каждом шаге обновляй минимум и двигай указатель у меньшего значения.`,
code:`class Solution {
...
// ===== QUEUE / DESIGN =====
{id:"192",t:"LC 362. Design Hit Counter",p:"Queue / Design",d:"средне",
...
Пример:
1) hit(1), hit(2), hit(3)
2) getHits(4) -> 3 (в окне [ -295 .. 4 ] три запроса: секунды 1,2,3)
3) hit(300)
4) getHits(300) -> 4 (в окне [ 1 .. 300 ] запросы: 1,2,3,300)
5) getHits(301) -> 3 (секунда 1 выпадает из окна, остаются 2,3,300)`,
starter:`class HitCounter {
    public HitCounter() {
        // TODO: инициализация структуры
    }

    public void hit(int timestamp) {
        // TODO: зафиксировать запрос
    }

    public int getHits(int timestamp) {
        // TODO: вернуть число запросов за последние 300 секунд
        return 0;
    }
}`,
...
{id:"193",t:"LC 933 · Number of Recent Calls",p:"Queue / Design",d:"легко",
...
// ===== GRAPH DFS =====
{id:"194",t:"LC 332 · Reconstruct Itinerary",p:"Graph DFS",d:"сложно",
...
Пример:
Ввод: tickets = [["MUC","LHR"],["JFK","MUC"],["SFO","SJC"],["LHR","SFO"]]
Вывод: ["JFK","MUC","LHR","SFO","SJC"]`,
hint:`Это путь Эйлера в ориентированном графе. Храним соседей в min-heap и делаем DFS по Хиерхольцеру: добавляем вершину в ответ при выходе из рекурсии.`,
code:`class Solution {
...
// ===== TREES / DFS =====
{id:"195",t:"LC 199 · Binary Tree Right Side View",p:"Trees / DFS",d:"средне",
desc:`Вернуть значения узлов, которые видны при взгляде на бинарное дерево справа.
...
// ===== QUEUE / DESIGN =====
{id:"196",t:"LC 380 · Insert Delete GetRandom O(1)",p:"Queue / Design",d:"средне",
...
Пример:
Ввод: ["RandomizedSet","insert","remove","insert","getRandom","remove","insert","getRandom"]
[[],[1],[2],[2],[],[1],[2],[]]
Вывод: [null,true,false,true,2,true,false,2]`,
hint:`Комбинация ArrayList + HashMap<value,index>. Для remove меняем удаляемый элемент местами с последним.`,
code:`class RandomizedSet {
    // Храним сами значения в ArrayList,
    // потому что по индексу можно получить элемент за O(1).
    // Это нужно для getRandom().
    private final List<Integer> values = new ArrayList<>();

    // Для каждого значения храним его индекс в списке values.
    // Это нужно, чтобы быстро проверять наличие элемента
    // и быстро находить, где он лежит при удалении.
    private final Map<Integer, Integer> index = new HashMap<>();

    private final Random random = new Random();

    public boolean insert(int val) {
        // Если значение уже есть в множестве,
        // второй раз добавлять его нельзя.
        if (index.containsKey(val)) {
            return false;
        }

        // Новый элемент добавляем в конец списка.
        // Его индекс сейчас равен values.size().
    ...
    public boolean remove(int val) {
        // Сначала находим индекс удаляемого элемента.
        // Если такого значения нет, удалить ничего нельзя.
        ...
        // Его удобно удалить за O(1), потому что он в конце.
        int lastIdx = values.size() - 1;
        int lastVal = values.get(lastIdx);

        // Переносим последний элемент на место удаляемого.
        // Так мы избегаем удаления из середины ArrayList,
        // которое стоило бы O(n) из-за сдвига элементов.
        values.set(i, lastVal);

        // Обновляем индекс перенесённого элемента:
        // теперь lastVal лежит не на lastIdx, а на позиции i.
        index.put(lastVal, i);

        // Удаляем последний элемент списка.
        // После переноса он стал "лишней копией".
        values.remove(lastIdx);

        // Удаляем значение из map,
        // потому что val больше не находится в RandomizedSet.
        index.remove(val);
    ...
    public int getRandom() {
        // Выбираем случайный индекс от 0 до values.size() - 1
        // и возвращаем элемент по этому индексу.
        // Так как каждый индекс выбирается с одинаковой вероятностью,
        // каждый элемент тоже выбирается равновероятно.
...
// ===== TWO POINTERS =====
{id:"197",t:"LC 88 · Merge Sorted Array",p:"Two Pointers",d:"легко",
desc:`Даны два отсортированных массива nums1 и nums2, где в nums1 есть место под все элементы. Нужно слить их в nums1 по возрастанию.

Пример:
Ввод: nums1 = [1,2,3,0,0,0], m = 3, nums2 = [2,5,6], n = 3
Вывод: [1,2,2,3,5,6]`,
hint:`Идём с конца: сравниваем хвосты nums1 и nums2 и ставим больший в конец nums1.`,
code:`class Solution {
...
// ===== TREES / DFS =====
{id:"198",t:"LC 236 · Lowest Common Ancestor of a Binary Tree",p:"Trees / DFS",d:"средне",
desc:`Дан корень бинарного дерева и два узла p и q. Найти их наименьшего общего предка (LCA).
ГАРАНТИРУЕТСЯ, что оба узла p и q СУЩЕСТВУЮТ в дереве.

Пример:
Ввод: root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1
Вывод: 3`,
hint:`DFS: если в поддереве найден p или q — возвращаем его. Если ответы есть с обеих сторон, текущий узел и есть LCA.`,
code:`class Solution {
    public TreeNode lowestCommonAncestor(TreeNode root, TreeNode p, TreeNode q) {
...
// ===== BINARY SEARCH =====
{id:"199",t:"LC 4 · Median of Two Sorted Arrays",p:"Binary Search",d:"сложно",
...
code:`class Solution {
    public double findMedianSortedArrays(int[] nums1, int[] nums2) {
        ...
        // Бинарный поиск нужно делать по меньшему массиву,
        // чтобы сложность была O(log(min(m, n))).
        // Если nums1 длиннее nums2 — меняем массивы местами.
        if (m > n) {
            return findMedianSortedArrays(nums2, nums1);
        }

        // half — сколько элементов должно быть в левой половине
        // после мысленного разреза двух массивов.
        //
        // +1 нужен для нечётной общей длины:
        // например, total = 5, тогда слева должно быть 3 элемента,
        // чтобы медиана была максимумом левой части.
        int half = (m + n + 1) / 2;

        // Будем бинарным поиском выбирать i:
        // сколько элементов берём в левую часть из nums1.
        //
        // i может быть от 0 до m:
        // 0 — ничего не взяли из nums1 влево,
        // m — весь nums1 взяли влево.
        int lo = 0;
        int hi = m;

        while (lo <= hi) {
            // i — позиция разреза в nums1
            int i = lo + (hi - lo) / 2;

            // j — позиция разреза в nums2.
            // Она определяется автоматически:
            // если всего слева должно быть half элементов,
            // а из nums1 мы взяли i, то из nums2 нужно взять half - i.
            int j = half - i;

            // left1 — последний элемент слева от разреза в nums1
            // right1 — первый элемент справа от разреза в nums1
            //
            // Если слева ничего нет, считаем left1 = -∞.
            // Если справа ничего нет, считаем right1 = +∞.
            int left1 = (i == 0) ? Integer.MIN_VALUE : nums1[i - 1];
            int right1 = (i == m) ? Integer.MAX_VALUE : nums1[i];

            // То же самое для nums2.
            int left2 = (j == 0) ? Integer.MIN_VALUE : nums2[j - 1];
            int right2 = (j == n) ? Integer.MAX_VALUE : nums2[j];

            // Проверяем, что разрез правильный:
            //
            // все элементы слева должны быть <= всех элементов справа.
            //
            // Так как массивы уже отсортированы внутри себя,
            // достаточно проверить только границы:
            // left1 <= right2 и left2 <= right1.
            if (left1 <= right2 && left2 <= right1) {

                // Если общее количество элементов чётное,
                // медиана — среднее двух центральных элементов.
                //
                // Левый центральный элемент — максимум слева.
                // Правый центральный элемент — минимум справа.
                if ((m + n) % 2 == 0) {
                    return (Math.max(left1, left2) + Math.min(right1, right2)) / 2.0;
                }

                // Если общее количество элементов нечётное,
                // левая половина содержит на один элемент больше.
                // Поэтому медиана — максимум левой части.
                return Math.max(left1, left2);

            } else if (left1 > right2) {
                // Мы взяли слишком много элементов из nums1 в левую часть.
                //
                // left1 оказался больше элемента справа во втором массиве,
                // значит разрез nums1 нужно сдвинуть левее.
                hi = i - 1;

            } else {
                // Иначе left2 > right1.
                //
                // Это значит, что мы взяли слишком мало элементов из nums1.
                // В правой части nums1 лежит слишком маленький элемент,
                // а во второй массив слева попал слишком большой.
                //
                // Нужно взять больше элементов из nums1 в левую часть.
                lo = i + 1;
            }
        }

        // Сюда корректный ввод попасть не должен.
        // Если попали — значит нарушено условие задачи:
        // массивы не отсортированы или входные данные некорректны.
...
// ===== SLIDING WINDOW =====
{id:"200",t:"LC 567 · Permutation in String",p:"Sliding Window",d:"средне",
desc:`Даны строки s1 и s2. Проверить, содержит ли s2 подстроку, являющуюся перестановкой s1.

Пример:
Ввод: s1 = "ab", s2 = "eidbaooo"
Вывод: true`,
hint:`Фиксированное окно длины s1.length(). Сравниваем частоты 26 букв.`,
code:`class Solution {
...
// ===== LINKED LIST =====
{id:"201",t:"LC 2 · Add Two Numbers",p:"Linked List",d:"средне",
desc:`Даны два неотрицательных числа в виде связных списков (цифры в обратном порядке). Вернуть сумму в том же формате.

Пример:
Ввод: l1 = [2,4,3], l2 = [5,6,4]
Вывод: [7,0,8]`,
hint:`Идём одновременно по двум спискам и переносим carry.`,
code:`class Solution {
...
// ===== STACK =====
{id:"202",t:"LC 155 · Min Stack",p:"Stack",d:"средне",
desc:`Реализовать стек с операциями push, pop, top и getMin за O(1).

Пример:
Ввод: ["MinStack","push","push","push","getMin","pop","top","getMin"]
[[],[-2],[0],[-3],[],[],[],[]]
...
// ===== HASHMAP =====
{id:"203",t:"LC 1436 · Destination City",p:"HashMap",d:"легко",
desc:`Дан список путей [from, to]. Нужно найти город, из которого нет исходящих путей.

Пример:
Ввод: paths = [["London","New York"],["New York","Lima"],["Lima","Sao Paulo"]]
Вывод: "Sao Paulo"`,
hint:`Собираем все города-источники в set. Ответ — тот to, которого нет в set.`,
code:`class Solution {
...
// ===== STRING =====
{id:"204",t:"LC 1446 · Consecutive Characters",p:"String",d:"легко",
...
{id:"205",t:"LC 771 · Jewels and Stones",p:"String",d:"легко",
...
// ===== BINARY SEARCH =====
{id:"206",t:"LC 35 · Search Insert Position",p:"Binary Search",d:"легко",
desc:`Дан отсортированный массив ==nums== из различных целых чисел и число ==target==.
...
Вывод: 1`,
hint:`Классический бинарный поиск. Если target не найден, после цикла left укажет позицию вставки.`,
code:`class Solution {
...
lcSimilar:[{"n":704,"t":"Binary Search","h":"binary-search"}]},

{id:"207",t:"LC 69 · Sqrt(x)",p:"Binary Search",d:"легко",
desc:`Дано неотрицательное целое число ==x==. Нужно вернуть целую часть квадратного корня из x (округление вниз).
...
Ввод: x = 8
Вывод: 2
Пояснение: sqrt(8) = 2.828..., округляем вниз до 2.`,
hint:`Бинарный поиск по ответу: ищем наибольшее mid, для которого mid*mid <= x. Чтобы избежать переполнения, сравнивай через mid <= x / mid.`,
code:`class Solution {
...
lcSimilar:[{"n":367,"t":"Valid Perfect Square","h":"valid-perfect-square"}]},

{id:"208",t:"LC 374 · Guess Number Higher or Lower",p:"Binary Search",d:"легко",
desc:`Играем в угадайку:
...
Ввод: n = 10, pick = 6
Вывод: 6`,
hint:`Используй бинарный поиск по диапазону [1..n]. По ответу guess(mid) сдвигай левую или правую границу.`,
...
lcSimilar:[{"n":35,"t":"Search Insert Position","h":"search-insert-position"},{"n":704,"t":"Binary Search","h":"binary-search"}]},

{id:"209",t:"LC 153 · Find Minimum in Rotated Sorted Array",p:"Binary Search",d:"средне",
desc:`Дан отсортированный массив без дубликатов, сдвинутый в неизвестной точке. Найти минимальный элемент за O(log n).
...
code:`class Solution {
    public int findMin(int[] nums) {
        ...
        while (left < right) {
            ...
            // значит мы в левой части, минимум справа
            if (nums[mid] > nums[right]) {
                left = mid + 1;
            } 
            // значит мы в правой части, минимум слева (включая mid)
            else {
                right = mid;
            }
        }
...
// ===== LINKED LIST =====
{id:"210",t:"LC 24 · Swap Nodes in Pairs",p:"Linked List",d:"средне",
desc:`Поменять местами соседние узлы связного списка попарно: 1->2->3->4 превращается в 2->1->4->3.

Пример:
Ввод: head = [1,2,3,4]
Вывод: [2,1,4,3]`,
hint:`Используем dummy и переставляем ссылки тройкой prev-a-b.`,
code:`class Solution {
...
// ===== MATH / SIMULATION =====
{id:"211",t:"LC 470 · Implement Rand10() Using Rand7()",p:"Math / Simulation",d:"средне",
...
// ===== STACK =====
{id:"212",t:"LC 71 · Simplify Path",p:"Stack",d:"средне",
desc:`Дан Unix-путь. Нормализовать его: убрать ".", обработать "..", лишние "/".
В Unix/Linux-путях точка "." означает текущую директорию. То есть она ничего не меняет в пути.

Пример:
Input: path = "/home/user/Documents/../Pictures"
Output: "/home/user/Pictures"`,
hint:`Разбиваем по '/', используем стек директорий.`,
code:`class Solution {
...
// ===== LINKED LIST =====
{id:"213",t:"LC 21 · Merge Two Sorted Lists",p:"Linked List",d:"легко",
desc:`Слить два отсортированных связных списка в один отсортированный.
...
// ===== SQL =====
{id:"214",t:"MIN и MAX зарплаты по отделу (не уволенные)",p:"SQL",d:"легко",
desc:`В базе данных две таблицы: ==units== (подразделения) и ==employees== (сотрудники).
...
hint:`Фильтр по уволенным в WHERE, затем GROUP BY unit_id и агрегаты MIN(salary), MAX(salary).`,
code:`SELECT
    unit_id,
