...
code:`public int[] slidingProduct(int[] arr, int k) {
        int n = arr.length;
...
expl:`Отслеживаем нули отдельно (zeroCount), так как у нас есть затем деление и ЧТОБЫ НЕ ВОЗНИКЛО ДЕЛЕНИЯ НА НОЛЬ.
Для ненулевых поддерживаем произведение, делим/умножаем при сдвиге окна. Если есть нули — результат = 0.`},
