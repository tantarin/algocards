    ...
    public boolean checkSubarraySum(int[] nums, int k) {
        ...
        for (int i = 0; i < nums.length; i++) {
            ...
            if (map.containsKey(prefix)) {
                ...
                // Нюанс 3: сохраняем ТОЛЬКО первое вхождение остатка
                // Почему? Потому что чем раньше индекс, тем больше шансов получить длину >=2
                // Если обновить на текущий i, то i - map.get(prefix) будет меньше
                map.put(prefix, i);
            }
        }
