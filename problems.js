...
Если элемент встречается в первом массиве 2 раза и во втором 2 раза — в ответе он тоже 2 раза. 
...
desc:`Под «невалидная строка» подразумевается строка, содержащая любые символы, кроме латинских букв верхнего регистра (A-Z).
...
code:`Сначала проверяем строку на валидность: разрешены только символы A-Z; любой другой символ делает строку невалидной.
Затем группируем одинаковые соседние символы в блоки. Для каждого блока добавляем символ и, если длина блока больше 1, его размер.
