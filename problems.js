...
diagram:{"type":"multi","steps":[
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[1]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"1"},{"type":"int","name":"expect","data":"1"},{"type":"String[]","name":"result","data":[]}],"desc":"**expect** — какое число мы ждём следующим в [lower, upper] без «дыры». Обработали **nums[0]=0**: **num > expect** ложь → в result ничего. После итерации: **expect = 1**, **idx = 1**."},
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[2]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"2"},{"type":"int","name":"expect","data":"2"},{"type":"String[]","name":"result","data":[]}],"desc":"Обработали **nums[1]=1**: дыры нет. **expect = 2**, **idx = 2**."},
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[3]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"3"},{"type":"int","name":"expect","data":"4"},{"type":"String[]","name":"result","data":["2"]}],"desc":"Только что обработали **nums[2]=3**: **3 > 2** — пропуск **[2, 2]** → **\"2\"**. Теперь **expect = 4**, **idx = 3** (следующий элемент — 50)."},
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[4]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"4"},{"type":"int","name":"expect","data":"51"},{"type":"String[]","name":"result","data":["2","4->49"]}],"desc":"После **nums[3]=50**: **50 > 4** → **\"4->49\"**. **expect = 51**, **idx = 4** (читаем **75**)."},
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"5 (конец)"},{"type":"int","name":"expect","data":"76"},{"type":"String[]","name":"result","data":["2","4->49","51->74"]}],"desc":"Обработали **nums[4]=75**: **75 > 51** → **\"51->74\"**. **expect = 76**, **idx = 5** — элементов больше нет."},
{"structs":[{"type":"int[]","name":"nums","data":[0,1,3,50,75],"active":[]},{"type":"int","name":"lower","data":"0"},{"type":"int","name":"upper","data":"99"},{"type":"int","name":"idx","data":"5"},{"type":"int","name":"expect","data":"76"},{"type":"String[]","name":"result","data":["2","4->49","51->74","76->99"]}],"desc":"После цикла: **expect (76) ≤ upper (99)** — хвост **[76, 99]** → **\"76->99\"**. Полный **result** совпадает с примером из условия."}
]}},
