...
{id:"dp2",t:"Разложение числа на минимальное количество квадратов",p:"Dynamic Programming",d:"средне",ya:true,
...
{id:"hf10",t:"LC 387. Первый уникальный символ в строке",p:"HashMap",d:"легко",ya:true,
...
{id:"hf11",t:"Group Anagrams для mixed-алфавита",p:"HashMap",d:"средне",ya:true,
...
{id:"hf12",t:"Первый уникальный символ в строке",p:"HashMap",d:"легко",ya:true,
desc:`Дана строка. Нужно вернуть ==первый символ== строки, который встречается в ней ровно один раз.
Если такого символа нет — вернуть специальное значение (например, '\0' или пустую строку, в зависимости от сигнатуры).
...
Пример 2:
Ввод: "aabbcc"
Вывод: '\0' (уникального символа нет)`,
...
{id:"hf13",t:"Группировка чисел по перестановке цифр (нули незначимы)",p:"HashMap",d:"средне",ya:true,
...
{id:"ya11",t:"Минимальная абсолютная разность между двумя массивами",p:"Two Pointers",d:"средне",ya:true,
