...
steps:`1) i, j — индексы следующего блока; cnt1, cnt2 — сколько ещё позиций текущих значений.
2) Если cnt==0 — читаем следующую пару из списка.
3) overlap = min(cnt1, cnt2); в ответ += val1*val2*overlap; cnt1 -= overlap; cnt2 -= overlap.
4) Повторять, пока оба вектора не исчерпаны.`,
code:`import java.util.*;
