...
diagram:{"type":"window","data":["A","A","B","A","B","B","A"],"steps":[{"wl":0,"wr":2,"desc":"Окно **AAB** (k=1): maxFreq=2, длина 3 → замен **3−2=1** ≤ k ✓"},{"wl":0,"wr":3,"desc":"**AABA**: maxFreq=3 (A), длина 4 → замен **1** ≤ k ✓, **result=4**"},{"wl":0,"wr":4,"desc":"**AABAB**: длина 5, maxFreq=3 → замен **2** > k ✗ — сдвигаем **L** вправо"},{"wl":1,"wr":4,"desc":"**ABAB**: замен **4−3=1** ≤ k ✓ (maxFreq=3 не падает — **допустимо** в этом алгоритме)"},{"wl":2,"wr":5,"desc":"**BABB**: замен 4−3=1 ≤ k ✓ Итог: **4**"}]}},
...
expl:`Так как A и B — перестановки, каждое число встречается ровно по 1 разу в каждом. 
freq[v] считает сколько раз v встретилось суммарно. Когда freq == 2 — число есть и в A[0..i], и в B[0..i].`},
...
// ===== СОРТИРОВКА + 2 УКАЗАТЕЛЯ =====
{id:"sw11",t:"Подсчёт пар индексов",p:"Сортировка + 2 указателя",d:"средне",
