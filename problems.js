...
Даны две строки s и t. Найти минимальную по длине подстроку в s, которая содержит все символы строки t (включая дубликаты). Если такой подстроки нет — вернуть пустую строку "".
...
Дан корень BST и вещественное число target (double). Найти значение узла в дереве, ближайшее к target.
...
Дан корень бинарного дерева. Проверить, что все листья находятся на одной глубине (расстоянии от корня).
