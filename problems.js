...
Расстояние между местами — ==разность индексов==. Для каждого свободного места рассматривается ближайшая занятая машина слева и справа; берётся ==минимум из двух расстояний==. Если с одной стороны машин нет — учитывается только другая сторона.
